...
begin    
 ...
 from sys.master_files a        
  left join sys.filegroups b on a.data_space_id=b.data_space_id --and database_id = db_id()        
 where         
...
SELECT 'WhosIsConsumingMyLog' = log_reuse_wait_desc FROM sys.databases WHERE name = DB_NAME(@dbid)  
